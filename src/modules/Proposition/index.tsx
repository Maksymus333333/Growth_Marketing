...
<div className='left-side'>
    ...
    <div className='proposition-list'>
                ...
                <div className='list-items'><img src={ListItem1}/>
                <p>Персоналізовану навчальну програму, адаптовану під твій рівень.</p>
                </div>
                <div className='list-items'><img src={ListItem2}/>
                <p>Регулярні менторські сесії для розбору складних тем і підтримки.</p>
                </div>
                <div className='list-items'><img src={ListItem3}/>
                <p>Практичні завдання, які підготують до реальної роботи.</p>
                </div>
                <div className='list-items'><img src={ListItem4}/>
                <p>Допомогу в створенні портфоліо та розвитку професійних навичок.</p>
                </div>
                <div className='list-items'><img src={ListItem5}/>
                <p>Сприяння в працевлаштуванні на прямі контракти в закордонні компанії з місячною зарплатою від $4,000 до $6,500.</p>
                </div>
                    <LogIn/>
                </div>
